...
export default function NewMarking() {
  ...
  const calculateVolume = (length, breadth, height, alliance) => {
    ...
    return isNaN(l) || isNaN(b) || isNaN(h) || l === 0 || b === 0 || h === 0
      ? "0.000"
      : ((l * b * h) / 1000000).toFixed(3);
  };
  ...
  return (
    <Layout>
      <div>
      <h1 className="text-4xl font-bold text-left">Add New Marking</h1>
        ...
        <div className="flex items-center gap-4 mt-4">
          <Input
            ...
            onChange={(e) =>
              setNewBlock({ ...newBlock, length: e.target.value })
            }
          />
          <Input
            type="number"
            placeholder="Breadth (cm)"
            value={newBlock.breadth}
            onChange={(e) =>
              setNewBlock({ ...newBlock, breadth: e.target.value })
            }
          />
          <Input
            type="number"
            ...
            onChange={(e) =>
              setNewBlock({ ...newBlock, height: e.target.value })
            }
          />
